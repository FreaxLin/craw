...
public class HttpGetTest {
    ...
    public void testGet() throws IOException {
        ...
        List<Map<String, Object>> result = jdbcTemplate.queryForList("SELECT url FROM craw_data.hupu_bxj_20200920");

        for (Map<String, Object> userUrl : result){
            String url = userUrl.get("url").toString() + "/profile";
